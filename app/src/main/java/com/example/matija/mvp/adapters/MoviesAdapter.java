package com.example.matija.mvp.adapters;
...
import com.example.matija.mvp.models.Result;
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MoviesHolder> {
    ...
    public class MoviesHolder extends RecyclerView.ViewHolder {
        ...
        public MoviesHolder(View v) {
            ...
            tvOverview = (TextView) v.findViewById(R.id.movie_over_view);
            tvReleaseDate = (TextView) v.findViewById(R.id.movie_release_date);
            ivMovie = (ImageView) v.findViewById(R.id.movie_image);
        }
    }
}
